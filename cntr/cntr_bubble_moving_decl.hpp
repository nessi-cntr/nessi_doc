...
/** \brief <b> Evaluate a bubble diagram (\f$C\f$) from two-time contour functions \f$A,B\f$ at the time step; \f$ C_{c_1,c_2}(t_1,t_2) = i  A_{a_1,a_2}(t_1,t_2) * B_{b_2,b_1}(t_2,t_1) \f$. </b>
 *
 * <!-- ====== DOCUMENTATION ====== -->
 *
 *  \par Purpose
 * <!-- ========= -->
 * Evaluate the two-time contour function \f$C\f$ represented as a bubble diagram with two-time functions \f$A,B\f$; \f$ C_{c_1,c_2}(t_1,t_2) = i  A_{a_1,a_2}(t_1,t_2) * B_{b_2,b_1}(t_2,t_1) \f$.
 ...
 * The evaluated value of \f$ i  A_{a_1,a_2}(t_1,t_2) * B_{b_2,b_1}(t_2,t_1)\f$ is stored at \f$ C_{c_1,c_2}(t_1,t_2)\f$.
 * <!-- ARGUMENTS
 *      ========= -->
 *
 * @param tstp
 * > Time step.
 * @param C
 * > Two-time contour object in the Matrix form defined as \f$ C_{c_1,c_2}(t_1,t_2) = i  A_{a_1,a_2}(t_1,t_2) * B_{b_2,b_1}(t_2,t_1) \f$.
 * @param c1
...
/** \brief <b> Evaluate a bubble diagram (\f$C\f$) from two-time contour functions \f$A,B\f$ at the time step; \f$ C_{0,0}(t_1,t_2) = i  A_{0,0}(t_1,t_2) * B_{0,0}(t_2,t_1) \f$. </b>
 *
 * <!-- ====== DOCUMENTATION ====== -->
 *
 *  \par Purpose
 * <!-- ========= -->
 * Evaluate the two-time contour function \f$C\f$ represented as a bubble diagram with two-time functions \f$A,B\f$; \f$ C_{0,0}(t_1,t_2) = i  A_{0,0}(t_1,t_2) * B_{0,0}(t_2,t_1) \f$.
 * Here it is assmued that \f$A\f$, \f$B\f$ and \f$C\f$ are \f$1\times 1\f$ matrices.
 * This evaluation is done at the time step (i.e. \f$ t_1 \f$ or \f$ t_2 \f$ is the time step) for all components (retarded, lesser, left-mixing and Matsubara).
 * The evaluated value of \f$ i  A_{0,0}(t_1,t_2) * B_{0,0}(t_2,t_1)\f$ is stored at \f$ C_{0,0}(t_1,t_2)\f$.
 * <!-- ARGUMENTS
 *      ========= -->
 *
 * @param tstp
 * > Time step.
 * @param C
 * > Two-time contour object in the \f$1\times 1\f$-Matrix form defined as \f$ C_{0,0}(t_1,t_2) = i  A_{0,0}(t_1,t_2) * B_{0,0}(t_2,t_1) \f$.
 * @param A
 ...
 */
template <class GGC, class GGA, class GGB> 
void Bubble1(GGC &C, GGA &A, GGB &B);
